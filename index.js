...
//4. Add your own bearer token
const yourBearerToken = "1cece4d8-83a3-430c-8393-d2b21f8cb05e"; //read to doc to generate this
...
// 6. handle post, put, patch, delete requests
app.post("/get-secret", async (req, res) => {
  ...
  try {
    ...
    res.render("index.ejs", {secret: error.response.data, user: "Error...",});
  }
});
